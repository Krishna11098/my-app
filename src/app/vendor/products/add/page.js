            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-800">
                        <h2 className="text-xl font-semibold mb-4 text-purple-400">Basic Details</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm text-gray-400 mb-1">SKU (Unique ID)</label>
                                <input required className="w-full bg-black border border-gray-700 rounded-lg p-3 outline-none"
                                    value={formData.sku} onChange={e => setFormData({ ...formData, sku: e.target.value.toUpperCase() })} placeholder="e.g. CAM-001" />
                            </div>
                            <div className="col-span-2">
                    ...
                    {/* Section: Images */}
                    <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-800">
                        <h2 className="text-xl font-semibold mb-4 text-purple-400">Product Images</h2>
                        ...
                        <p className="text-xs text-gray-500 mt-2">* At least one image is recommended.</p>
                    </div>

                    {/* Section: Attributes */}
                    <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-800">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-xl font-semibold text-purple-400">Attributes & Variants</h2>
                            <button type="button" onClick={addAttributeRow} className="text-sm text-purple-400 hover:text-white underline">+ Add Attribute</button>
                        </div>
                        <div className="space-y-3">
                            {attributes.map((attr, index) => (
                                <div key={index} className="flex gap-4">
                                    <input placeholder="Name (e.g. Color)" className="flex-1 bg-black border border-gray-700 rounded-lg p-2 text-sm outline-none"
                                        value={attr.key} onChange={e => handleAttributeChange(index, 'key', e.target.value)} />
                                    <input placeholder="Value (e.g. Red)" className="flex-1 bg-black border border-gray-700 rounded-lg p-2 text-sm outline-none"
                                        value={attr.value} onChange={e => handleAttributeChange(index, 'value', e.target.value)} />
                                    <button type="button" onClick={() => removeAttributeRow(index)} className="text-red-500 hover:text-red-400">×</button>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-900/50 p-6 rounded-2xl border border-gray-800">
                        <h2 className="text-xl font-semibold mb-4 text-purple-400">Inventory & Value</h2>
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        <button type="submit" disabled={loading} className="px-6 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-bold transition-all shadow-lg shadow-purple-900/20 flex-1">
